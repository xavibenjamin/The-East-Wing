	...
	<div class="container">
		<div class="row content">
		  <div class="eightcol contact">
		    <h2>Get In Touch</h2>
		    <p>Thanks for wanting to get in touch! We'd love to hear from you! Use the form below or by email at <a href="mailto:hello@theeastwing.net">hello@theeastwing.net</a>. If you're interesting in advertising on our show, please consult the <a href="/advertise">Advertise</a> page.</p>
					...
					<div class="entry-content">
						...
						<form action="<?php the_permalink(); ?>" class="contactForm" method="post">
							...
							<fieldset>
								...
								<textarea name="comments" maxlength="200" placeholder="Question? Comment? Rant? Drop us a line." class="input message required requiredField"><?php if(isset($_POST['comments'])) { if(function_exists('stripslashes')) { echo stripslashes($_POST['comments']); } else { echo $_POST['comments']; } } ?></textarea>
								<?php if($commentError != '') { ?>
